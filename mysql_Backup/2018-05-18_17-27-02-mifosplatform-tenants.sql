...
--
-- Current Database: `mifosplatform-tenants`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mifosplatform-tenants` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `schema_version` VALUES (1,1,'1','mifos-platform-shared-tenants','SQL','V1__mifos-platform-shared-tenants.sql',98913810,'root','2018-04-09 10:05:10',994,1),(2,2,'2','externalize-connection-properties','SQL','V2__externalize-connection-properties.sql',-862567945,'root','2018-04-09 10:05:12',1310,1),(3,3,'3','deadlock-retry-properties','SQL','V3__deadlock-retry-properties.sql',1523909379,'root','2018-04-09 10:05:12',619,1),(4,4,'4','introduced oltpId reportId columns and tenants server connection table','SQL','V4__introduced_oltpId_reportId_columns_and_tenants_server_connection_table.sql',417291024,'root','2018-04-09 10:05:12',65,1);
...
INSERT INTO `tenant_server_connections` VALUES (1,'localhost','mifostenant-default','3310','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1),(2,'localhost','mifostenant-arouna','3310','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1),(3,'localhost','mifostenant-cynthia','3310','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1),(4,'localhost','mifostenant-simple','3310','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1),(5,'localhost','mifostenant-easy','3310','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1),(6,'localhost','mifostenant-cynthi','3310','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1),(7,'localhost','mifostenant-xyz','3306','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1),(8,'localhost','mifostenant-arounaNdam','3310','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1);
...
INSERT INTO `tenants` VALUES (1,'default','Default Demo Tenant','Asia/Kolkata',NULL,NULL,NULL,NULL,1,1),(2,'arouna','Arouna MSCG','Africa/Douala',NULL,NULL,NULL,NULL,2,2),(3,'cynthia','Cynthia MSCG','Africa/Douala',NULL,NULL,NULL,NULL,3,3),(4,'simple','simple','Africa/Douala',NULL,NULL,NULL,NULL,4,4),(5,'easy','aesy','Africa/Douala',NULL,NULL,NULL,NULL,5,5),(6,'cynthi','cynthi','Africa/Douala',NULL,NULL,NULL,NULL,6,6),(7,'arounaNdam','arounaNdam Ltd.','Africa/Douala',NULL,NULL,NULL,NULL,8,8);
...
-- Dump completed on 2018-05-18 17:27:02
